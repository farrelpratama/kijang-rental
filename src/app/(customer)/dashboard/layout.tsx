    ...
    <div className="flex min-h-screen bg-[#F8FAFC]">
      ...
      <aside className="hidden w-64 flex-col bg-[#031636] py-8 text-white shadow-xl lg:flex fixed h-full z-30">
        ...
        <div className="px-4 mt-auto border-t border-white/10 pt-6">
          <div className="flex items-center gap-3 px-4 mb-4">
            <div className="relative h-10 w-10 overflow-hidden rounded-full bg-slate-600 border border-white/10 flex items-center justify-center font-bold text-white text-sm">
              {initials}
            </div>
      ...
      >
        ...
        >
          ...
          <div className="px-4 mt-auto border-t border-white/10 pt-6">
            <div className="flex items-center gap-3 px-4 mb-4">
              <div className="h-10 w-10 overflow-hidden rounded-full bg-slate-650 border border-white/10 flex items-center justify-center font-bold text-white text-sm">
                {initials}
              </div>
              <div>
