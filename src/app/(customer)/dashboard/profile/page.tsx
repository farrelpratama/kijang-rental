...
export default function ProfilePage() {
  ...
  const getVerificationBanner = () => {
    if (ktpStatus === "Verified" && simStatus === "Verified") {
      return (
        <div className="rounded-xl bg-emerald-50 p-6 flex items-start gap-4 shadow-sm">
      ...
      return (
        <div className="rounded-xl bg-amber-50 p-6 flex items-start gap-4 shadow-sm">
      ...
      return (
        <div className="rounded-xl bg-red-50 p-6 flex items-start gap-4 shadow-sm">
      ...
      return (
        <div className="rounded-xl bg-slate-50 p-6 flex items-start gap-4 shadow-sm">
