...
export default function StatsGrid({
  ...
  return (
    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="rounded-[32px] border border-slate-150 bg-white p-6 shadow-sm flex items-center gap-5">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-600 shrink-0">
      ...
      {/* Total Rentals Card */}
      <div className="rounded-[32px] border border-slate-150 bg-white p-6 shadow-sm flex items-center gap-5">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-50 text-slate-600 shrink-0">
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="rounded-[32px] border border-slate-150 bg-white p-6 shadow-sm flex items-center gap-5">
        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-50 text-amber-600 shrink-0">
          <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
